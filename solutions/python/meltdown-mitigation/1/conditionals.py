...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    return temperature < TEMPERATURE_CEIL and neutrons_emitted > BASE_NEUTRONS and temperature*neutrons_emitted < PRODUCT_T_N
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    efficiency = voltage/theoretical_max_power * current * PERCENTAGE
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    stat = temperature/threshold * neutrons_produced_per_second
