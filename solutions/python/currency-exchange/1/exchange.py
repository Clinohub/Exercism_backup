...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    actual_exchange_rate = exchange_rate*(PERCENTAGE+spread)/PERCENTAGE
    money= exchange_money(budget, actual_exchange_rate)
    leftover_of_bills = get_leftover_of_bills(money, denomination)
    
    return int(money - leftover_of_bills)
